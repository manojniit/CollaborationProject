...
GetzChat.controller("forumController",function($scope,$http,$rootScope)
		{
	$http.get("http://localhost:8066/mychat/viewForum").then(function (response) {$scope.forums= response.data;});
	...
	$scope.saveEdit=function()
	{
		...
		$http.put('http://localhost:8066/mychat/updateForum',forum);
	$http.get("http://localhost:8066/mychat/viewForum").then(function (response) {$scope.forums = response.data;});
	}
	$scope.deleteForum=function(forumDataToEdit)
	{
		...
		$http['delete']('http://localhost:8066/mychat/deleteForum/'+forumDataToEdit.question_Id);
		 $http.get("http://localhost:8066/mychat/viewForum")
...
$scope.newBlog={};
	...
	$scope.addBlog=function(newBlog)
	{
		...
		var res=$http.post('http://localhost:8066/mychat/createBlogs',blog);
		$http.get("http://localhost:8066/mychat/viewBlogs").then(function (response) {$scope.blogs= response.data;});
		res.success(function(data, status, headers, config) {
			$scope.message = data;
		console.log("status:"+status);
	...
	$scope.saveEdit=function()
	{
		...
		$http.put('http://localhost:8066/mychat/updateBlog',blog);
	$http.get("http://localhost:8066/mychat/viewBlogs").then(function (response) {$scope.blogs = response.data;});
	}
